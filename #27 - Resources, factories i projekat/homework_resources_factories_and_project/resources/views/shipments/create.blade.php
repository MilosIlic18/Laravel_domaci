...
@section('content')
    <div class="max-w-2xl mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('shipments.store') }}" method="POST">
            ...
            <!-- User ID -->
            <div class="mb-4">
                <label for="user_id" class="block font-medium mb-1">ID korisnika</label>
                <input type="number" name="users_id" id="user_id"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2
                    @error('users_id') border-red-500 ring-red-300 @else border-gray-300 ring-blue-400 @enderror"
