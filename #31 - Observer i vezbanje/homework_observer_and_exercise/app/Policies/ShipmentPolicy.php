...
class ShipmentPolicy
{
    ...
    {
        return $user->role === User::ROLE_ADMINISTRATOR || $user->id === $shipment->clients_id;
    }
    ...
    public function createViewPage(User $user): bool
    {
        return $user->role === User::ROLE_ADMINISTRATOR;
    }

    public function editViewPage(User $user): bool
    {
        return $user->role === User::ROLE_ADMINISTRATOR;
    }
}
