    ...
    @section('contents')
        ...
        <form class="max-w-sm mx-auto bg-white rounded-lg p-[20px] mt-10">
            ...
            <div class="mb-5">
                ...
                <input id="theme" email="subject" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="tema poruke" required />
            </div>
