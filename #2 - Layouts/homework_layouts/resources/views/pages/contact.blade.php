@extends('layouts.layout')
    ...
    @section('contents')
        ...
        <form class="max-w-sm mx-auto bg-white rounded-lg p-[20px] mt-10">
            ...
            <div class="mb-5">
                ...
                <input id="theme" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="tema poruke" required />
            </div>
            <div class="flex flex-col mb-5">
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900">Poruka</label>
                <textarea id="message" class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" rows="4" placeholder="Poruka"></textarea>
            </div>
