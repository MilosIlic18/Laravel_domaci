...
use App\Http\Middleware\GuestUserCheckMiddleware;


Route::middleware([GuestUserCheckMiddleware::class])->prefix("/")->group(function(){
...
Route::middleware(['auth',UserCheckMiddleware::class])->controller(ShoppingCartController::class)->prefix("/carts")->name("cart.")->group(function(){
    Route::get("","index")->name("index");
    Route::get("delete","destroy")->name("destroy");
    Route::post("","store")->name("store");
    Route::post("finish","orderStore")->name("orderStore");
});
