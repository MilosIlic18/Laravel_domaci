...
Route::prefix('/')->name('user.')->group(function() {
    ...
    Route::controller(UserCitiesController::class)->prefix('favourites')->name("city.")->group(function(){
        Route::get('{city}','favourite')->name("favourite");
        Route::get('delete/{city}','unFavourite')->name("unFavourite");
    });
