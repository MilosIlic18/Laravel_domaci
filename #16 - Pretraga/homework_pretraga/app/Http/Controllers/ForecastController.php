...
class ForecastController extends Controller
{
    //
    function index() {
        return view("pages.admin.forecast.index",["cities"=>Cities::with(Forecast::TABLE)->get()]);
    }
    ...
    function search(Request $request) {
        ...
        return view("pages.forecast.index",["searchParam"=>$request->get("city"),"cities"=>$cities]);
    }
