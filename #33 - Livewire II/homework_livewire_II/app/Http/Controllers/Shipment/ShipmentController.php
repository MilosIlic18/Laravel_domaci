...
class ShipmentController extends Controller
{
    ...
    {
        //
        Cache::remember('shipments_status_unassigned',300,fn()=>Shipment::unassignedShipments()->get()); // Kes traje 5 min
    ...
    {
        //
        Gate::authorize('editViewPage',Shipment::class);
    ...
    public function assignUser(Request $request,Shipment $shipment):RedirectResponse{
        $request->validate(['users_id'=>'required|exists:users,id']);
        $shipment->users_id = $request->users_id;
