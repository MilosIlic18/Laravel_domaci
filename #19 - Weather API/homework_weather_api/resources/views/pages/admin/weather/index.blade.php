            ...
            <tbody>
                ...
                <tr class="bg-white border-b border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-[5px] justify-center">
                        <a href="{{route('weather.destroy',$cityTemperature->id)}}" class="mb-[5px] text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center">Obrisi</a>
